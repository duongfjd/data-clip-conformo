...
# Định nghĩa template cho dataset (phù hợp với loại dữ liệu)
template = ['a photo of {}.']  # Điều chỉnh phù hợp với loại dữ liệu
...
class Dataset(_TorchDataset):
    ...
    def __init__(self, transform=None):
        ...
        self.dataset_dir = os.path.join(root, "my_new_dataset")  # Thay đổi tên thư mục
        self.image_dir = os.path.join(self.dataset_dir, "images")  # Điều chỉnh thư mục ảnh
        self.split_path = os.path.join(self.dataset_dir, "split_zhou_MyNewDataset.json")  # Điều chỉnh tên file split
        ...
        print("MY_NEW_DATASET Num of samples: " + str(len(self.data)), end="\n")
